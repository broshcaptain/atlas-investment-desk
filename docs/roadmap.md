...
**Sırada:**
- Master prompt'un 9 adımı, sabah brifingi LLM entegrasyonu, KAP metin temizliği + duyuru özeti ve Gemini→Groq geçişi tamamlandı; şu an için belirlenmiş yeni bir adım yok.
